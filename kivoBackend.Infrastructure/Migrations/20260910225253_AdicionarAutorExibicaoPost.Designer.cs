...
namespace kivoBackend.Infrastructure.Migrations
{
    ...
    [Migration("20260910225253_AdicionarAutorExibicaoPost")]
    partial class AdicionarAutorExibicaoPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kivoBackend.Core.Entities.Campeonato", b =>
                {
                    ...
                    b.Property<Guid?>("TimeVencedorId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("kivoBackend.Core.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("kivoBackend.Core.Entities.Post", b =>
                {
                    b.HasOne("kivoBackend.Core.Entities.Usuario", "Autor")
                        .WithMany()
